from picozero import Speaker #librairie utiliser pour le buzzer
...
#tableau qui comprend les notes de musique, la lettre représente la note en anglais et le numéro représente son emplacement sur la portée : ['note', battement]
...
for note in liten_mus:
    speaker.play(note) #va jouer les notes du tableau "listen_mus" de musique de manière consecutive
